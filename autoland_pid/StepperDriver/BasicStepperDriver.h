...
public:
    ...
    BasicStepperDriver(int steps, int dir_pin, int step_pin, int enable_pin, int sleep_pin, int home_pin);
    ...
    //Enable sleep to conserve power while the motor is not in use.
    void sleep(void);
    void wakeup(void);
